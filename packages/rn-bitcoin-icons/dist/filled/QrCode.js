...
const SvgQrCode = (props) => (<Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <Path fillRule="evenodd" d="M5 5h4.5v4.5H5V5zm1.5 1.5V8H8V6.5H6.5zm8-1.5H19v4.5h-4.5V5zM16 6.5V8h1.5V6.5H16zm-11 8h4.5V19H5v-4.5zM6.5 16v1.5H8V16H6.5z" clipRule="evenodd"/>
