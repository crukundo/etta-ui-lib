...
export const getPreviousCodesFromPaths =
  (nextSvgPaths, previousCodes) => (acc, iconName) =>
...
const getPreviousCodesForNextBuild = (previousCodesFilePath, nextSvgPaths) => {
  ...
  return Object.keys(previousCodes).reduce(
    getPreviousCodesFromPaths(nextSvgPaths, previousCodes),
    {}
  );
};
