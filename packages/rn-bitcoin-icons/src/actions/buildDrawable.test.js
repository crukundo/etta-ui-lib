...
describe('buildDrawable', () => {
  ...
  it('should call svg2vectordrawable with the given svgs', () =>
    buildDrawable(data).then(() =>
      expect(svg2vectordrawable).toHaveBeenCalledWith('<svg><circle/></svg>')
    ));

  it('should return the drawables outputs', () =>
    buildDrawable(data).then(response => {
